...
To apply the patch, change the vcsRoot with uuid = '50fcdffb-6d49-43d4-a0fc-8e6dbc47a532ReleaseVcsRoot' (id = 'NuGet_Kotlin_Miruken_MirukenSln_ReleaseVCSRoot')
accordingly and delete the patch script.
*/
changeVcsRoot("50fcdffb-6d49-43d4-a0fc-8e6dbc47a532ReleaseVcsRoot") {
