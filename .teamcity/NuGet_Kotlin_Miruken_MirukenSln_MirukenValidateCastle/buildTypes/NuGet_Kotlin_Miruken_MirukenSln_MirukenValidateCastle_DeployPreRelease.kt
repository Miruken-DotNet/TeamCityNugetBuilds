package NuGet_Kotlin_Miruken_MirukenSln_MirukenValidateCastle.buildTypes
...
object NuGet_Kotlin_Miruken_MirukenSln_MirukenValidateCastle_DeployPreRelease : BuildType({
    template = "StandardNuGetBuildTemplate"
    uuid = "50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenValidateCastle_DeployPreRelease"
    id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenValidateCastle_DeployPreRelease"
    ...
    triggers {
        finishBuildTrigger {
            id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenValidateCastle_DeployPreRelease_TRIGGER"
    ...
    dependencies {
        dependency(NuGet_Kotlin_Miruken_MirukenSln.buildTypes.NuGet_Kotlin_Miruken_MirukenSln_PreReleaseBuild) {
            ...
            artifacts {
                id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenValidateCastle_PreRelease_ARTIFACT_DEPENDENCY"
