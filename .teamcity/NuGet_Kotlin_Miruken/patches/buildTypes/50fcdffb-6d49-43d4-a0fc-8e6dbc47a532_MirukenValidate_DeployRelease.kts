...
To apply the patch, create a buildType with uuid = '50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenValidate_DeployRelease' (id = 'NuGet_Kotlin_Miruken_MirukenSln_MirukenValidate_DeployRelease')
in the project with uuid = '50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenValidate' and delete the patch script.
*/
create("50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenValidate", BuildType({
