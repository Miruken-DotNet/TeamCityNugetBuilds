...
To apply the patch, change the buildType with uuid = '50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenValidate_DeployRelease' (id = 'NuGet_Kotlin_Miruken_MirukenSln_MirukenValidate_DeployRelease')
accordingly and delete the patch script.
*/
changeBuildType("50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenValidate_DeployRelease") {
    check(paused == false) {
