...
To apply the patch, change the buildType with uuid = 'd8420070-ca13-4e71-886c-72d00f96d535_MirukenMediateCastle_DeployRelease' (id = 'NuGet_Kotlin_Miruken_MirukenMediateSln_MirukenMediateCastle_DeployRelease')
accordingly and delete the patch script.
*/
changeBuildType("d8420070-ca13-4e71-886c-72d00f96d535_MirukenMediateCastle_DeployRelease") {
    expectSteps {
        step {
    ...
    triggers {
        val trigger1 = find<FinishBuildTrigger> {
            finishBuildTrigger {
                buildTypeExtId = "NuGet_Kotlin_Miruken_MirukenMediateSln_ReleaseBuild"
                branchFilter = "+:master"
            }
        }
        trigger1.apply {
