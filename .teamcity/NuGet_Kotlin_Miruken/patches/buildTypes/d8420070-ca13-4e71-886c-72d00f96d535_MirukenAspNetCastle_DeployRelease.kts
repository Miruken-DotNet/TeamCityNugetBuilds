...
To apply the patch, change the buildType with uuid = 'd8420070-ca13-4e71-886c-72d00f96d535_MirukenAspNetCastle_DeployRelease' (id = 'NuGet_Kotlin_Miruken_MirukenMediateSln_MirukenAspNetCastle_DeployRelease')
accordingly and delete the patch script.
*/
changeBuildType("d8420070-ca13-4e71-886c-72d00f96d535_MirukenAspNetCastle_DeployRelease") {
    check(paused == false) {
