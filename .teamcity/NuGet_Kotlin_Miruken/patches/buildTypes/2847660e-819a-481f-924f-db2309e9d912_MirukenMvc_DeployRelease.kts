...
To apply the patch, change the buildType with uuid = '2847660e-819a-481f-924f-db2309e9d912_MirukenMvc_DeployRelease' (id = 'NuGet_Kotlin_Miruken_MirukenMvcSln_MirukenMvc_DeployRelease')
accordingly and delete the patch script.
*/
changeBuildType("2847660e-819a-481f-924f-db2309e9d912_MirukenMvc_DeployRelease") {
    expectSteps {
        step {
