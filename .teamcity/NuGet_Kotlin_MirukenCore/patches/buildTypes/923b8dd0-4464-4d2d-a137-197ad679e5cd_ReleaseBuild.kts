...
To apply the patch, change the buildType with uuid = '923b8dd0-4464-4d2d-a137-197ad679e5cd_ReleaseBuild' (id = 'NuGet_Kotlin_MirukenCore_MirukenSln_ReleaseBuild')
accordingly, and delete the patch script.
*/
changeBuildType(uuid("923b8dd0-4464-4d2d-a137-197ad679e5cd_ReleaseBuild")) {
    expectSteps {
        powerShell {
    ...
    steps {
        update<DotnetPackStep>(5) {
            enabled = false
        }
        update<DotnetPackStep>(7) {
            enabled = false
        }
    }
}
