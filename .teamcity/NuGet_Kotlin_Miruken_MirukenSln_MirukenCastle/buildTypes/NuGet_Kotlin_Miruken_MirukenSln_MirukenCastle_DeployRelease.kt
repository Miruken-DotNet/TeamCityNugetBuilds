...
object NuGet_Kotlin_Miruken_MirukenSln_MirukenCastle_DeployRelease : BuildType({
    template = "StandardNuGetBuildTemplate"
    uuid = "50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenCastle_DeployRelease"
    id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenCastle_DeployRelease"
    name = "Deploy Release"
    ...
    triggers {
        finishBuildTrigger {
            id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenCastle_Release_TRIGGER"
    ...
    dependencies {
        dependency(NuGet_Kotlin_Miruken_MirukenSln.buildTypes.NuGet_Kotlin_Miruken_MirukenSln_ReleaseBuild) {
            ...
            artifacts {
                id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenCastle_Release_ARTIFACT_DEPENDENCY"
