...
object NuGet_Kotlin_Miruken_MirukenSln_MirukenValidate_DeployRelease : BuildType({
    template = "StandardNuGetBuildTemplate"
    uuid = "50fcdffb-6d49-43d4-a0fc-8e6dbc47a532_MirukenValidate_DeployRelease"
    id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenValidate_DeployRelease"
    name = "Deploy Release"
    ...
    triggers {
        finishBuildTrigger {
            id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenValidate_Release_TRIGGER"
    ...
    dependencies {
        dependency(NuGet_Kotlin_Miruken_MirukenSln.buildTypes.NuGet_Kotlin_Miruken_MirukenSln_ReleaseBuild) {
            ...
            artifacts {
                id = "NuGet_Kotlin_Miruken_MirukenSln_MirukenValidate_Release_ARTIFACT_DEPENDENCY"
